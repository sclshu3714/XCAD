...
namespace XModel.Common
{
    ...
    /// 
    /// </summary>
    public class XAppDomainLoadContext
    {
        public XAppDomainLoadContext(string name, bool isCollectible = false) { 
        ...
        public static AppDomain AssemblyLoad(XPluginAssembly plugin, ref XDesignPlugin DesignPlugin)
        {
    ...
    #region 字段属性
        private static Dictionary<string, AppDomain> LoadedAssemblys { get; set; }
