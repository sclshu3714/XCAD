  ...
  double operator() ( int Row,  int Col) 
{
  ...
  //! T2.Transforms(P2){ }                  // P1 = P2 !!!
   gp_GTrsf2d Multiplied ( gp_GTrsf2d T){ }
   gp_GTrsf2d operator * ( gp_GTrsf2d T) 
{
  return Multiplied(T){ }
}
  
   public void Multiply ( gp_GTrsf2d T){ }
public void operator *= ( gp_GTrsf2d T)
{
  Multiply(T){ }
}
  ...
  //! transformation is not inversible.
   gp_GTrsf2d Powered ( int N){ }
  
    public void Transforms (gp_XY Coord){ }
  
     gp_XY Transformed ( gp_XY Coord){ }
