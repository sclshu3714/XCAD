...
//! unit vector ructions
//! Geom_Direction which provides additional functions for
//! ructing unit vectors and works, in particular, with the
...
public class gp_Dir 
{
  ...
  //! ruct the direction and the method raises the
  //! exception ConstructionError.
    gp_Dir( double Xv,  double Yv,  double Zv){ }
  ...
  //! The tolerance criterion is Resolution from package gp.
   double AngleWithRef ( gp_Dir Other,  gp_Dir VRef){ }
  ...
  public void operator ^= ( gp_Dir Right)
{
  Cross(Right){ }
}
  ...
  //! can't be normalized to create a direction.
   gp_Dir Crossed ( gp_Dir Right){ }
   gp_Dir operator ^ ( gp_Dir Right) 
{
  ...
  //! is null and cannot be normalized.
     gp_Dir CrossCrossed ( gp_Dir V1,  gp_Dir V2){ }
  
  //! Computes the scalar product
    double Dot ( gp_Dir Other){ }
  double operator * ( gp_Dir Other) 
{
  return Dot(Other){ }
}
  ...
  //! raises an exception even if V1 and V2 are parallel.
    double DotCross ( gp_Dir V1,  gp_Dir V2){ }
   ...
   gp_Dir operator -() 
{
  ...
  //! Ang is the angular value of the rotation in radians.
     gp_Dir Rotated ( gp_Ax1 A1,  double Ang){ }
