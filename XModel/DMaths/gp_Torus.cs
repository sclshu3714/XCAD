...
public class Standard_DimensionError;
public class gp_Ax3;
public class gp_Ax1;
public class gp_Pnt;
public class gp_Ax2;
...
//! complex torus ructions
//! Geom_ToroidalSurface which provides additional
//! functions for ructing tori and works, in particular,
...
public class gp_Torus 
{
  ...
  //! Raises ConstructionError if MinorRadius < 0.0 or if MajorRadius < 0.0
    gp_Torus( gp_Ax3 A3,  double MajorRadius,  double MinorRadius){ }
  ...
  //! Ang is the angular value of the rotation in radians.
     gp_Torus Rotated ( gp_Ax1 A1,  double Ang){ }
  ...
  //! The absolute value of S is used to scale the torus
     gp_Torus Scaled ( gp_Pnt P,  double S){ }
  
    public void Transform ( gp_Trsf T){ }
  

  //! Transforms a torus with the transformation T from public class Trsf.
     gp_Torus Transformed ( gp_Trsf T){ }
