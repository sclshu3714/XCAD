...
public class gp_Ax3 
{
  ...
  gp_Ax3( gp_Pnt P,  gp_Dir N,  gp_Dir Vx){ }
  

  //! Creates an axis placement with the  "Location" point <P>
  //! and the normal direction <V>.
   gp_Ax3( gp_Pnt P,  gp_Dir V){ }
  ...
  //! <Other> are parallel (same or opposite orientation).
    Standard_Boolean IsCoplanar ( gp_Ax3 Other,  double LinearTolerance,  double AngularTolerance){ }
  ...
  //! in radians.
   gp_Ax3 Rotated ( gp_Ax1 A1,  double Ang){ }
  ...
  //! . The "XDirection" and the "YDirection" are reversed.
  //! So the axis placement stay right handed.
   gp_Ax3 Scaled ( gp_Pnt P,  double S){ }
  ...
  //! point <P2>.
   gp_Ax3 Translated ( gp_Pnt P1,  gp_Pnt P2){ }
